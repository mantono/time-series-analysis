...
class TrendsTest
{
    private val list1: List<DataPoint<Int>> = listOf(
        Data(Instant.ofEpochSecond(1), 15),
        Data(Instant.ofEpochSecond(10), 10),
        Data(Instant.ofEpochSecond(20), 8),
        Data(Instant.ofEpochSecond(30), 6)
    )

    @Test
    fun trendTestBySum()
    {
        val trend: Trend = trend(list1, Instant.EPOCH, Instant.ofEpochSecond(35))
    ...
    {
        val trend: Trend = trend(list1, Duration.ofSeconds(25), Instant.ofEpochSecond(31))
    ...
    {
        val trend: Trend = trend(list1, Duration.ofSeconds(30), Instant.ofEpochSecond(29))
